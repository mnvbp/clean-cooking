# ============================================================================
# CONFIG.R - Survey Configuration -- Zambia 2024
# ============================================================================
#
...
BASE_DIR   <- "Zambia 2024 R/data"

# Results are written here (created automatically if missing)
OUTPUT_DIR <- "Zambia 2024 R/outputs"
...
# DATA_FILES$hr <- "ZMHR81FL.DTA"
# DATA_FILES$br <- "ZMBR81FL.DTA"
# DATA_FILES$mr <- "ZMMR81FL.DTA"
...
OUTCOMES_WOMEN <- list(
  ...
  hypertension = list(
    label           = "Hypertension",
    weight_override = NULL          # Phase 8 standardized variable — see VAR_MAP_WOMEN$bp_var
  )
)
...
VAR_MAP_WOMEN <- list(
  ...
  anemia_var   = "v457",
  pregterm_var = "v228",
  bp_var       = "chd02",   # Phase 8 standardized BP variable (was s1110a in 2018)
  # VERIFY: confirm chd02 is coded 0=no, 1=yes before running
...
VAR_MAP_CHILDREN <- list(
  ...
  # Outcomes
  anemia_var     = "hc57",
  age_months_var = "b19",    # DHS-8 recommendation over hc1 — see variable_helpers.R
  cough_var      = "h31",
  bw_var         = "m19",
  bw_flag_var    = "m19a",
